...
export default function ProfilePage() {
  ...
  //       hideEmail: user.hide_email ?? false,
  //     }
  //   : {}
  ...
  }, [displayName, department, imageUrl, publicProfile, hideEmail, user])

  const handleToggle = async (type: 'publicProfile' | 'hideEmail', value: boolean) => {
    if(!user) return
    const updates: Record<string, unknown> = {};
    if (type === 'publicProfile') {
      setPublicProfile(value)
      updates.public_profile = value
    } else {
      setHideEmail(value)
      updates.hide_email = value
    }
    ...
    <div className='min-h-screen bg-zinc-900 text-white'>
      <div className='max-w-5xl mx-auto p-6'>
        ...
        {(displayName === '' || department === '') && (
          <div className='mb-4 bg-yellow-600/20 text-yellow-400 px-4 py-3 rounded text-sm'>
        ...
        <div className='bg-zinc-800 rounded-lg p-6 mb-8 border border-zinc-700'>
              ...
              <div className='flex flex-wrap gap-6 mt-4'>
                ...
                <label className='flex items-center gap-2 cursor-pointer'>
                  <input
                    ...
                    className='w-4 h-4 accent-blue-500'
                    checked={hideEmail}
                    onChange={(e) => handleToggle('hideEmail', e.target.checked)}
                  />
          ...
          <div className='flex justify-end mt-6'>
            <button
              className='px-5 py-2.5 bg-blue-600 rounded font-medium hover:bg-blue-700 transition-colors flex items-center gap-2 disabled:opacity-60'
